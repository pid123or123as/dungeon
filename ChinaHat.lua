...
function ChinaHat.Init(UI, Core, notify)
    ...
    local State = {
        ChinaHat = {
            ...
            HatParts = { Value = 120, Default = 120 },
    ...
    if UI.Tabs and UI.Tabs.Visuals then
        local chinaHatSection = UI.Sections.ChinaHat or UI.Tabs.Visuals:Section({ Name = "ChinaHat", Side = "Right" })
        ...
        local circleSection = UI.Sections.Circle or UI.Tabs.Visuals:Section({ Name = "Circle", Side = "Right" })
